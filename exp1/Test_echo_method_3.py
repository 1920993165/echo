...
MODEL_PATH = os.environ.get('MODEL_PATH', '/data1/lwt/model/echo/echo28/chatglm3-7B')
...
for one in testd:
    ...
    while assi_idx<length_chat:
        ...
        test_idx+=3
        assi_idx+=3
    if not os.path.exists('echo-m3-chatglm3'):
        os.mkdir('echo-m3-chatglm3')
    #保存结果
    with open("echo-m3-chatglm3/echo-m3-chatglm3-"+str(count)+".json", "w", encoding="utf-8") as file:
